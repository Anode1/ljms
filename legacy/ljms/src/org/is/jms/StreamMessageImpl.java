 ...
 * @since jdk1.0
 */
class StreamMessageImpl extends MessageImpl implements StreamMessage, Cloneable, Streamable{
  ...
  public Object readObject() throws JMSException{
    ...
    throw new IllegalArgumentException("readObject is not supported: use your own, custom serialization");
  }
  ...
  public String toString(){
    ...
    StringBuffer sb=new StringBuffer("<STREAM_MESSAGE>");
    sb.append(super.toStringInternal());
    sb.append("</STREAM_MESSAGE>");
		return sb.toString();
  }

	public Object clone() throws CloneNotSupportedException{

    StreamMessageImpl m=(StreamMessageImpl)super.clone();
    return m;
  }
