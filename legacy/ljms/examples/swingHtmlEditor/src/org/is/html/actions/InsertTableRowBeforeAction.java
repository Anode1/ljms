 ...
 * @since jdk1.2
 */
public class InsertTableRowBeforeAction extends TableRowActionBase{

  public InsertTableRowBeforeAction(){

    super("insert-table-row-before");
  }
  ...
  public void doWithRow(GHTMLDocument doc, Element te, Element currentRowElement, int index)throws Exception{
    ...
    doc.insertBeforeStart(currentRowElement, html);
